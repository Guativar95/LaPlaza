...
export const SecureVehicleList = () => {
  ...
  const { items, isFetching, pagination, filters } = useApiPagination<Vehicle>({
    fetchDataFn,
    pageSize: 7,
  })
  ...
  return (
    <MainLayout title='Seguro'>
      <h1 className='text-left text-2xl text-primary-700 font-bold mb-3'>Seguro</h1>
      <div className='mb-3'>
