...
export type CreditFormProps = {
  ...
  actions?: ReactNode
  saveProgressOnChange?: (values: DefaultValues<FullCreditValues>) => void
}
...
export const CreditForm: FC<CreditFormProps> = ({
  ...
  const selectedCreditValues = useMemo(() => {
    if (defaultValues && defaultValues.deadline && defaultValues.initialPayment) {
      return {
        fee: defaultValues.deadline,
        initialPayment: defaultValues.initialPayment,
      }
    }
            ...
            <div className='grid gap-3 md:grid-cols-2'>
              <SelectField
                ...
                registration={register('deadline', {
                  ...
                  onBlur: () => saveProgressOnChange?.({ ...getValues(), valueToFinance }),
                })}
